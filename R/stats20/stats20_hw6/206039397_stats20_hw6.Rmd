...
my_gregexpr <- function(pattern, text)
{
  ...
  { 
    ...
    for(i in seq_along(para))
    {
      ...
      # if i is at end OR found is true
      if(i == seq_along(para)[length(seq_along(para))] | index_found == TRUE)
      {
        # add list to res
        res[[i_txt]] <- c(index_text, length_pattern, type, bool)
...
# test
gregexpr(21,c(1564921654,48973512648))
my_gregexpr(21,c(1564921654,48973512648))
