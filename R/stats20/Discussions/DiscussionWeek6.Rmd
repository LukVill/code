...
# 2: diag makes identity matrix with nrows, so 
all(diag(5) == diag(nrow = 5))

# 3: diag makes identity matrix of nxn
nrow(diag(5)) == 5

# 4: diag treats this vector as a "data" vector, making identity matrix with this data along the diagonal
all(diag(diag(1:5)) == 1:5)
