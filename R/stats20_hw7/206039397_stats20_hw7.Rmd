...
# plot nonsmoker hist
plot(hist(new_births$weight[new_births$Habit == "NonSmoker"], freq = FALSE), density = 40, col = "green")

# plot smoker hist
plot(hist(new_births$weight[new_births$Habit == "Smoker"], freq = FALSE), density = 40, col = "red")
